...
Parallel.Invoke(new Action[]{
    new Action(()=>SingletoneLazy.GetInstance.PrintDetails("Air1")),
    new Action(()=>SingletoneLazy.GetInstance.PrintDetails("Air2")),
    new Action(()=>SingletoneLazy.GetInstance.PrintDetails("Air3")),
    new Action(()=>SingletoneLazy.GetInstance.PrintDetails("Air4")),
    new Action(()=>SingletoneLazy.GetInstance.PrintDetails("Air5")),
    new Action(()=>SingletoneLazy.GetInstance.PrintDetails("Air6")),});
